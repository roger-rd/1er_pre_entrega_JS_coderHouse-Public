...
let detallesPedido = `Detalles del pedido:\n`;
 ...
 // Obtener el nombre del cliente y mesa
 do {
...
propinaPorcentaje = parseFloat(prompt("Ingrese el porcentaje de propina (por ejemplo, 10 para el 10%)"));
...
alert(`CUENTA MESA: ${mesa}\n Cliente: ${nombre} \n ${detallesPedido} \n Gracias  por ser cliente de nuestro Restaurante,`);
